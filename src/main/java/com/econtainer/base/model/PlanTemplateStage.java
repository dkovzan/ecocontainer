...
@Entity
@Table(name = "PlanTemplateStage")
public class PlanTemplateStage {
    ...
    public boolean equals(Object o) {
        ...
        PlanTemplateStage that = (PlanTemplateStage) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, planTemplateId, stage, description, duration, startTime, endTime,
                solutionA, solutionB, solutionC, ppmMin, ppmMax,
                waterPHMin, waterPHMax, waterTempMin, waterTempMax, waterECMin, waterECMax,
                airTempMin, airTempMax, airHumidityMin, airHumidityMax,
                co2Min, co2Max, dissOxygenMin, dissOxygenMax, createdOn, updatedOn);
    }

    @Override
    public String toString() {
        return "PlanTemplateStage{" +
                "id=" + id +
